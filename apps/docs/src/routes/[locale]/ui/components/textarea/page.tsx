    ...
    <div className="mx-auto flex max-w-4xl flex-col gap-8 px-6 py-12 md:px-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-fg-mute text-lg">
          <Rich>{m.components.textarea.description()}</Rich>
        </p>
        <div>
          <Anchor
...
/>`}
        ...
        <div className="flex flex-col gap-4">
          <Heading level="h3">
            <Rich>{m.components.textarea.rowsTitle()}</Rich>
          </Heading>
          <ComponentPreview
            code={`<Textarea
  id="textarea-rows"
...
/>`}
        ...
        <div className="flex flex-col gap-4">
          <Heading level="h3">
            <Rich>{m.components.textarea.autoResizeTitle()}</Rich>
          </Heading>
          <ComponentPreview
            code={`<Textarea
  id="textarea-auto"
...
/>`}
        ...
        <div className="flex flex-col gap-4">
          <Heading level="h3">
            <Rich>{m.components.textarea.disabledTitle()}</Rich>
          </Heading>
          <ComponentPreview
            code={`<Textarea
...
/>`}
        ...
        <div className="flex flex-col gap-4">
          <Heading level="h3">
            <Rich>{m.components.textarea.invalidTitle()}</Rich>
          </Heading>
          <ComponentPreview
            code={`<Textarea
  id="textarea-invalid"
