...
export const ja = {
  ...
  'home.disciplinePlatformDescription':
    'コア4ブラウザに載った時点（Baseline newly available）で使う。その30か月後の widely available は待たない。ポリフィルもフォールバックも持たない。最新の機能で作っている以上、動かすには最新のブラウザが要る。古いブラウザを切っているのではなく、最初からそこでは動かない。',
